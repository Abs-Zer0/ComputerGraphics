...
public class Material {
    ...
    /**
    * Создаёт экземпляр класса с заданными цветом - color, коэффициентоми Фонга - phong,
    * отражения - reflection, преломления - refraction
    */
    ...
    */
    ...
    /**
    * Создаёт экземпляр класса с заданными цветом - color, коэффициентом Фонга - phong
    */
